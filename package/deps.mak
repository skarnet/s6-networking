...
s6-tlsc: EXTRA_LIBS := -lskarnet ${CRYPTO_LIB} ${SOCKET_LIB} ${SPAWN_LIB} ${SYSCLOCK_LIB}
s6-tlsc: src/conn-tools/s6-tlsc.o ${LIBCRYPTOSUPPORT}
s6-tlsclient: EXTRA_LIBS := -lskarnet
s6-tlsclient: src/conn-tools/s6-tlsclient.o
s6-tlsd: EXTRA_LIBS := -lskarnet ${CRYPTO_LIB} ${SOCKET_LIB} ${SPAWN_LIB} ${SYSCLOCK_LIB}
s6-tlsd: src/conn-tools/s6-tlsd.o ${LIBCRYPTOSUPPORT}
